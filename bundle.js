...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sample = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_Sample2.default, null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactExpander = __webpack_require__(160);

	var _Expandable = __webpack_require__(164);
	...
	var Sample = function (_React$Component) {
	  ...
	  _createClass(Sample, [{
	    ...
	    value: function render() {
	      ...
	      var expandHandlers = _props.expandHandlers;
	      var expander = _props.expander;

	      return _react2.default.createElement(
	        'div',
	        _extends({ className: 'sample-container' }, expandHandlers),
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_Board2.default, { expander: expander })
	          )
	        ),
	...
	exports.default = (0, _reactExpander.allowExpandingIn)(Sample);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _allowExpandingIn = __webpack_require__(161);

	Object.defineProperty(exports, 'allowExpandingIn', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_allowExpandingIn).default;
	  }
	});

	var _beExpandable = __webpack_require__(162);

	Object.defineProperty(exports, 'beExpandable', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_beExpandable).default;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function allowExpandingIn(ContainerComp) {
	  return _react2.default.createClass({
	    _expanderId: 0,

	    render: function render() {
	      return _react2.default.createElement(ContainerComp, _extends({}, this.props, {
	    ...
	    makeExpander: function makeExpander() {
	      ...
	      return function (props) {
	        return {
	          props: props,
	          key: ++_this2._expanderId,
	          startResizing: _this2.startResizing
	        };
	      };
	    },
	    startResizing: function startResizing(connector) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SizeMeasurer = __webpack_require__(163);
	 ...
	 */
	function beExpandable(Component) {
	  return _react2.default.createClass({
	    ...
	    render: function render() {
	      ...
	      var expander = _props.expander;
	      var expanders = _props.expanders;

	      var props = _objectWithoutProperties(_props, ['size', 'expander', 'expanders']);
	    ...
	    getExpanders: function getExpanders() {
	      ...
	      var expander = _props2.expander;
	      var expanders = _props2.expanders;

	      return expander ? [expander] : expanders;
	    },
	    normalizeExpanders: function normalizeExpanders(expanders) {
	      return expanders.map(function (expander) {
	    ...
	    renderExpanders: function renderExpanders() {
	      var _this = this;

	      var expanders = this.getExpanders();
	      return this.normalizeExpanders(expanders).map(function (exp) {
	        return _this.renderExpander(exp.key, exp.props);
	      });
	    },
	    ...
	    startResizing: function startResizing(e) {
	      var directions = arguments.length <= 1 || arguments[1] === undefined ? 'bottom right' : arguments[1];
	      var connector = arguments[2];
	      var _state = this.state;
	      var width = _state.width;
	      var height = _state.height;

	      this._measurer = new _SizeMeasurer.SizeMeasurer({
	        width: width,
	        height: height,
	        clientX: e.clientX,
	        clientY: e.clientY,
...
/***/ function(module, exports) {
	...
	var SizeMeasurer = exports.SizeMeasurer = function () {
	  function SizeMeasurer(_ref) {
	    var width = _ref.width;
	    var height = _ref.height;
	    var clientX = _ref.clientX;
	    var clientY = _ref.clientY;
	    var _ref$directions = _ref.directions;
	    var directions = _ref$directions === undefined ? 'bottom right' : _ref$directions;

	    _classCallCheck(this, SizeMeasurer);

	    this._start = {
	      width: width, height: height, clientX: clientX, clientY: clientY
	    };

	    var _normalizeDirections = normalizeDirections(directions);

	    var dirX = _normalizeDirections.dirX;
	    var dirY = _normalizeDirections.dirY;

	    this._measureWidth = measures[dirX];
	    this._measureHeight = measures[dirY];
	  }

	  _createClass(SizeMeasurer, [{
	    key: 'measureWidth',
	    value: function measureWidth(nextClientX) {
	      var _start = this._start;
	      var width = _start.width;
	      var clientX = _start.clientX;

	      return this._measureWidth(width, clientX, nextClientX);
	    }
	  }, {
	    key: 'measureHeight',
	    value: function measureHeight(nextClientY) {
	      var _start2 = this._start;
	      var height = _start2.height;
	      var clientY = _start2.clientY;
	...
	var measures = exports.measures = {
	  ...
	  bottom: function bottom(height, fromY, toY) {
	    return height + toY - fromY;
	  },
	  left: function left(width, fromX, toX) {
	...
	function normalizeDirections() {
	  ...
	  var dirs = directions.split(/\s+/);

	  if (dirs.length === 1) {
	    var dir = dirs[0];
	    var _dirY = isDirY(dir) ? dir : 'asIs';
	    var _dirX = isDirX(dir) ? dir : 'asIs';
	    return { dirY: _dirY, dirX: _dirX };
	  }

	  var _dirs = _slicedToArray(dirs, 2);
	  ...
	  var _ref2 = isDirY(d1) ? [d1, d2] : [d2, d1];
	...
	var isDirY = function isDirY(dir) {
	  return dir === 'top' || dir === 'bottom';
	};
	var isDirX = function isDirX(dir) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactExpander.beExpandable)(Expandable);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement("i", { className: "header__source__icon fa fa-github" }),
	        _react2.default.createElement(
	          "span",
	          { className: "header__source__name" },
	          "Source"
	        )
	      )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Poster = __webpack_require__(168);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'https://github.com/ryym/react-expander/tree/master/example' },
	              'here'
	            ),
	            '.'
	          ),
	    ...
	    value: function renderDescription() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          '. You can expand some elements in this page as you like by drag and drop. There are also options to expand only width or height.'
	        )
	      );
	    }
	  }]);
